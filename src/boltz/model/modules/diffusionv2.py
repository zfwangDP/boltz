...
class AtomDiffusion(Module):
    ...
    def sample(
        ...
        **network_condition_kwargs,
        ...
        if steering_args is not None and (steering_args["fk_steering"] or steering_args["physical_guidance_update"] or steering_args["contact_guidance_update"]):
        ...
        for step_idx, (sigma_tm, sigma_t, gamma) in enumerate(sigmas_and_gammas):
            ...
            if (steering_args["physical_guidance_update"] or steering_args["contact_guidance_update"]) and scaled_guidance_update is not None:
            ...
            with torch.no_grad():
                ...
                if steering_args["fk_steering"] and (
                    ...
                    if (steering_args["physical_guidance_update"] or steering_args["contact_guidance_update"]) and noise_var > 0:
                        ll_difference = (
                ...
                if (
                    (steering_args["physical_guidance_update"] or steering_args["contact_guidance_update"])
